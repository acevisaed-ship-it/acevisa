    ...
    >
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-white/70">
              Current counselor:{' '}
              <span className={currentCounselorName ? 'font-medium text-white' : 'font-medium text-orange'}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="transfer-counselor" className="mb-1.5 block text-sm text-white/70">
              Transfer to:
            </label>
            <select
          ...
          <div>
            <label htmlFor="transfer-reason" className="mb-1.5 block text-sm text-white/70">
