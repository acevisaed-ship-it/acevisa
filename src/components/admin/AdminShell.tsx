...
import { PageHeaderActionsContext } from '@/components/dashboard/PageHeaderActionsContext'
...
export function AdminShell({
  ...
  const [pageHeaderActions, setPageHeaderActions] = useState<React.ReactNode>(null)
