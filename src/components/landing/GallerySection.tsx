      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="md:hidden">
          <div className="flex flex-col gap-2">
            {stories.map((story, i) => (
              ...
              >
                <Card className="flex flex-row items-center gap-3 p-3" style={{ background: 'rgba(238,238,237,0.25)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.5)' }}>
        ...
        >
          {stories.map((story, i) => (
            ...
            >
              <Card className="flex h-full flex-col gap-4" style={{ background: 'rgba(238,238,237,0.25)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.5)' }}>
